...
- 🎆 Японские шоу-эффекты: вращающиеся лучи за головой, конфетти, искры-звёзды,
  слэм-тексты («СУПЕР!», «ОГО!»), вспышки, гроза при дожде
- 🎨 8 ярких игровых фонов (неон, огонь, космос, кибер, закат, радуга, океан, ретро-сетка) — случайный на каждый ответ
- 🖼 Пульсирующая тройная неоновая окантовка силуэта
...
1. При старте игры фоном грузится `vision_bundle.mjs` + WASM + модель (`AI: загрузка модели…` → `AI: готово ✓`)
